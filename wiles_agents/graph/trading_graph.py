...
from wiles_agents.agents.utils.memory import FinancialSituationMemory
from wiles_agents.agents.utils.agent_states import (
    AgentState,
    InvestDebateState,
    RiskDebateState,
)
from wiles_agents.dataflows.config import set_config

# Import the new abstract tool methods from agent_utils
from wiles_agents.agents.utils.agent_utils import (
    get_stock_data,
    get_indicators,
    get_fundamentals,
    get_balance_sheet,
